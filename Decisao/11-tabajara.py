...
#salários até R$ 280,00 (incluindo) : aumento de 20%, salários entre R$ 280,00 e R$ 700,00 : aumento de 15%
...
print('Salário inicial de R$ ', salario, 'reais')
print('Percentual de aumento: ', percentual, '%')
print('Aumento de R$ ', aumento, 'reais')
print('Novo salário R$ ', novo_sal, 'reais')